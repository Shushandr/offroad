...
public class GpxUiHelper {
	...
	public static String getDescription(OsmWindow app, GPXFile result, File f, boolean html) {
		GPXTrackAnalysis analysis = result.getAnalysis(f == null ? 0 : f.lastModified());
		return getDescription(app, analysis, html);
	}

	public static String getDescription(OsmWindow app, TrkSegment t, boolean html) {
	...
	public static String getDescription(OsmWindow app, GPXTrackAnalysis analysis, boolean html) {
...
//		OsmWindow app = (OsmWindow) activity.getApplication();
...
//		final OsmWindow app = (OsmWindow) activity.getApplication();
//		final File dir = app.getAppPath(IndexConstants.GPX_INDEX_DIR);
