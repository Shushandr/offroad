...
//		final LocationManager service = (LocationManager) app.getSystemService(OsmWindow.LOCATION_SERVICE);
...
//			return null;
//		}
//		LocationManager service = (LocationManager) app.getSystemService(OsmWindow.LOCATION_SERVICE);
...
//			((SensorManager) app.getSystemService(OsmWindow.SENSOR_SERVICE)).unregisterListener(this);
//			sensorRegistered = false;
//			heading = null;
//		} else if (!sensorRegistered && register) {
//			Log.d(PlatformUtil.TAG, "Enable sensor"); //$NON-NLS-1$
//			SensorManager sensorMgr = (SensorManager) app.getSystemService(OsmWindow.SENSOR_SERVICE);
...
//	}
	...
	public static net.osmand.Location convertLocation(Location l, OsmWindow app) {
		if (l == null) {
			return null;
		}
...
//	}
	...
	public void showNavigationInfo(TargetPoint pointToNavigate, OsmWindow uiActivity) {
...
//	
	...
	public boolean checkGPSEnabled(final OsmWindow context) {
		return false;
//		LocationManager lm = (LocationManager)app.getSystemService(OsmWindow.LOCATION_SERVICE);
