...
public class TargetPointsHelper {
	...
	private void updateRoutingHelper() {
		...
		Location lastKnownLocation = null; //FIXME: Implement? ctx.getLocationProvider().getLastKnownLocation();
	...
	public boolean checkPointToNavigateShort(){
    	if(pointToNavigate == null){
    		...
    		JOptionPane.showMessageDialog(null, R.string.mark_final_location_first);
			return false;
		}
    	return true;
    }
