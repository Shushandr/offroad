 ...
 * @date 19.05.2017
 */
public class RemovePointFromPolylineAction extends OffRoadAction {

	private Polyline mPolyline;
	private LatLon mLatLon;

	public RemovePointFromPolylineAction(OsmWindow pContext, Polyline pPolyline, LatLon pLatLon) {
		super(pContext, pContext.getOffRoadString("offroad.remove_point_from_polyline"), null);
		mPolyline = pPolyline;
		mLatLon = pLatLon;
	}
	...
	public void actionPerformed(ActionEvent pE) {
		mContext.getDrawPanel().getPolylineLayer().removePolylinePoint(mPolyline, mLatLon);
